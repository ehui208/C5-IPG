...
int g722_encode(struct g722_encode_state *s, u_int8_t g722_data[], const int16_t amp[], int len);
...
int g722_decode(struct g722_decode_state *s, int16_t amp[], const u_int8_t g722_data[], int len);
